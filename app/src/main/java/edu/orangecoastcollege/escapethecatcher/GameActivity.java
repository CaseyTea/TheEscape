...
public class GameActivity extends AppCompatActivity implements GestureDetector.OnGestureListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Instantiate out gesture detector
        ...
        for(int row = 0; row < ROWS; row++)
        {
            for (int col = 0; col < COLS; col++)
            {
                ...
                if (viewToInflate != null)
                {
                    ...
                    // Add the view to the relative layout of Imageviews
    ...
    private void createZombie() {
        ...
        // Set where to place image view when it is inflated
    ...
    private void createPlayer() {
        ...
        // Set where the player image view when it is inflated
    ...
    private void movePlayer(float velocityX, float velocityY) {
        ...
        {
            // Set zombie image to bunny
            // increment win counter
            wins++;
            // Restart game
            startNewGame();
        }
        else if(zombie.getCol() == player.getCol() && zombie.getRow() == player.getRow())
        {
